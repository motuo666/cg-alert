...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
    <html><head><title>CG Alert — Reports</title>
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
    <style>
      body{font-family:system-ui,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;background:#0b1020;color:#e5e9ff;margin:0}
      header{padding:18px 16px;background:#0f1530;border-bottom:1px solid #26314a}
      h1{font-size:22px;margin:0;color:#e5e9ff}
