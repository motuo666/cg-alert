...
export default {
  async fetch(request, env) {
    ...
    <style>body{font:16px/1.6 -apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica,Arial;color:#0b1533;max-width:720px;margin:10vh auto;padding:0 16px}</style>
